...
/// <summary>
/// Complete input scenario: calendar, central body, orbiting bodies, and calculation request.
/// </summary>
public sealed class ScenarioInput
{
    /// <summary>Calendar and time configuration for the mission.</summary>
    public CalendarInput Calendar { get; set; } = new();
    /// <summary>Central gravitational body (e.g. Sun).</summary>
    public CentralBodyInput CentralBody { get; set; } = new();
    /// <summary>Orbiting bodies available for origin/destination selection.</summary>
    public List<BodyInput> Bodies { get; set; } = [];
    /// <summary>Calculation request: origin, destination, timing, and parking orbit.</summary>
    public CalculationRequest Request { get; set; } = new();
}

/// <summary>
/// Calendar/schedule configuration for the mission.
/// </summary>
...
/// <summary>
/// Central gravitational body definition.
/// </summary>
...
/// <summary>
/// Orbiting body definition with orbital elements.
/// </summary>
...
/// <summary>
/// Orbital elements (semi-major axis, eccentricity, etc.) with optional secular rates.
/// </summary>
...
/// <summary>
/// Calculation request: origin, destination, timing, and parking orbit parameters.
/// </summary>
